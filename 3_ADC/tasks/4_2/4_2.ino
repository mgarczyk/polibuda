/*
If you are lucky (a lot of interference in the environment), it will be possible to perform a very spectacular experiment. 
Use the previously connected circuit with 5 diodes. Disconnect the wire going to the potentiometer and leave it in the air.
What happens when you bring your hand close to the wire (without touching the tip)? 
In my case, with the wire hanging in the air, 3 LEDs were lit, 
but it was enough to bring your hand within 2cm of the wire and all LEDs were then lit. Any idea why this is happening?

This experience should stick in your mind as proof that you should not leave any circuit inputs "hanging" in the air. 
See what problems can result from this!
*/
