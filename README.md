...
Od podstaw, przez algorytmy, struktury danych, wizualizacje danych, po ciekawsze projekty z bazami danych, obsługą API, prostymi grami, RL (Uczenie maszynowe), statystyką, CPS (Cyfrowe Przetwarzanie Sygnałów). Aż po systemy wbudowane oraz naukę obsługi mikroprocesorów i mikrokontrolerów w celu tworzenia użytecznych urządzeń elektronicznych codziennego użytku.
