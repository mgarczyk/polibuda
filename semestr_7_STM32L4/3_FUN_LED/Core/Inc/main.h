...
/* Private defines -----------------------------------------------------------*/
#define BUTTON_FORWARD_Pin GPIO_PIN_13
...
#define BUTTON_BACKWARD_LED_Pin GPIO_PIN_8
#define BUTTON_BACKWARD_LED_GPIO_Port GPIOC
#define BUTTON_LED_MODE_Pin GPIO_PIN_9
#define BUTTON_LED_MODE_GPIO_Port GPIOC
